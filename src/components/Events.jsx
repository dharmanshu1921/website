                ...
                <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
                  ...
                  <div className="flex flex-col justify-center flex-1 p-6 bg-gray-50">
                    ...
                    <p className="mb-2 text-gray-600">
                      ...
                      Quam cumque soluta maiores fugiat perspiciatis provident
                      velit ducimus quo earum, ab ut adipisci exercitationem
                      obcaecati voluptatem, tempora expedita voluptas porro
                      officia? Lorem ipsum dolor sit amet, consectetur
                      adipisicing elit. Atque temporibus ducimus, voluptatem
                      cumque saepe, suscipit fuga accusantium commodi alias
                      distinctio unde voluptate esse ex. Quaerat architecto quia
                      voluptatum rerum enim?
                    </p>
